...
def getNewData():
	...
	access_token="1282214051842363392-p6Yf6sHW5hzYDzkgqjnuEcNMpjQvpN"
	access_token_secret="zgkqkXdwNWR8G3QRdllpI4ouLHFdupO8R48FuKV8ohra9"
	consumer_key="x5vHN78aFmrstv5CeZXnDeCgZ"
	consumer_secret="njRthb0AstTkg8x8aCx2x1sBrrjFndlQ8yfAYFEYUjHsCsHQz8"
	...
	tweets = tweepy.Cursor(api.search, q="pandemic -filter:retweets",lang="en",geocode=locationString(l), tweet_mode='extended').items(numTweets)
...
def preditionsHere(db_tweets):
	...
	data=list(counts['output'])
		# tweets_100 = [*range(1, 101, 1)]
		#sentiments_list = db_tweets['output'].to_list()
		# db_tweets['tweetcreatedts']=db_tweets['tweetcreatedts'].dt.date
		# db_tweets.groupby(['tweetcreatedts','output'])
		# print(db_tweets[['tweetcreatedts','output']])
...
def home(request):
	 ...
	 new_df = getNewData()
	 # # use for context dict : list(db_tweets['output']) ||
	 if new_df.empty:
	 	 return render(request,'error.html',{})
	
	 # labels,data=[],[]
	 # ls=['January', 'February', 'March', 'April', 'May', 'June', 'July']
